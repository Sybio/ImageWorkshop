...
class ImageWorkshopLayer
{
     ...
     * @var string
     *
     * Default new image background color if none is given
     */
     ...
     * @var string
     *
     * Default text color when writing on an image if none is given
     */
    protected $defaultTextColor = '666666';
     ...
     * @param array     $exif      EXIF data for the image
     * @param string    $bgColor   a default image background color for new images
     * @param string    $textColor a default text color when writing text
     * @throws \ImageWorkshopLayerException
     */
    public function __construct($image, array $exif = array(), $bgColor = null, $textColor = null)
    {
        ...
        $this->defaultBackgroundColor = !empty($bgColor)
            ? $bgColor
            : $this->defaultBackgroundColor;

        $this->defaultTextColor = !empty($textColor)
            ? $textColor
     ...
     *
     * @param bool $deleteSubImgVar Delete sublayers image resource var, defaults to true
     */
     ...
     *
     * @see $position: http://phpimageworkshop.com/doc/22/corners-positions-schema-of-an-image.html
     ...
     * Be careful: some filters can damage transparent images, use it sparingly!
     ...
     * @param string  $align
     */
    public function writeText($text, $font = 1, $color = null, $positionX = 0, $positionY = 0, $align = 'horizontal')
    {
        $color = (empty($color)) ? $this->defaultTextColor : $color;
    ...
    public function resizeInPourcent($percentWidth = null, $percentHeight = null, $converseProportion = false, $positionX = 0, $positionY = 0, $position = 'MM')
    {
	  ...
	  /**
     * Resize by largest side in percent
     *
     * @deprecated
     * @see resizeByLargestSideInPercent
    ...
    public function resizeByLargestSideInPourcent($newLargestSideWidth, $converseProportion = false)
    {
	  ...
	  /**
     * Resize narrow side in percent
     *
     * @deprecated
     * @see resizeByNarrowSideInPercent
    ...
    public function cropInPourcent($percentWidth = 0, $percentHeight = 0, $positionXPercent = 0, $positionYPercent = 0, $position = 'LT')
    {
	  ...
	  /**
     * Crop maximum in percent
     *
     * @deprecated
     * @see cropMaximumInPercent
     * @param int    $positionXPercent
     * @param int    $positionYPercent
     * @param string $position
     * @throws \ImageWorkshopLayerException
